...
public class PortfolioController {
    ...
    public ResponseEntity<ApiResponse<List<PortfolioHoldingDto>>> getHoldings(@AuthenticationPrincipal String userId) {
        String uid = (userId != null) ? userId : "user_001";
        return ResponseEntity.ok(ApiResponse.of(portfolioService.getHoldings(uid)));
    }
