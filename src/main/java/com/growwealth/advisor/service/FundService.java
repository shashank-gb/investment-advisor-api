...
public class FundService {
    ...
    public List<MutualFundDto> getTopFunds(String category, Integer limit) {
        ...
        System.out.println("Top funds -> " + funds);
    ...
    public FundDetailDto getFundDetail(String fundId) {
        ...
        if (fund.getHoldings() != null && !fund.getHoldings().isEmpty()) {
            ...
            holdings = List.of(
                    HoldingDto.builder().name("HDFC Bank Ltd").companyName("Financials").weightage(9.5).build(),
                    HoldingDto.builder().name("ICICI Bank Ltd").companyName("Financials").weightage(8.2).build(),
                    HoldingDto.builder().name("Reliance Industries").companyName("Energy").weightage(7.1).build(),
                    HoldingDto.builder().name("Infosys Ltd").companyName("Technology").weightage(5.4).build(),
                    HoldingDto.builder().name("TCS").companyName("Technology").weightage(4.8).build()
            );
        }
